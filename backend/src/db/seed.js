...
async function seedDatabase() {
  ...
  await sql`INSERT INTO campaigns (campaign_id, tenant_id, business_id, location_id, name, google_review_url, rush_hours, thank_window_hours, enable_voice_linkage, enable_influencer_capture, enable_incentives, enable_referrals, created_at, updated_at) VALUES ('c1a2b3c4-5d6e-7f8a-9b0c-1d2e3f4a5b6c', 't_itl_001', 'b_marios', 'loc_main', ${"Mario's Italian Kitchen — Main St"}, 'https://g.page/r/marios-kitchen/review', ${rushHours1}, 24, true, true, true, true, '2026-01-15T10:00:00Z', '2026-02-10T14:30:00Z')`;

  await sql`INSERT INTO campaigns (campaign_id, tenant_id, business_id, location_id, name, google_review_url, rush_hours, thank_window_hours, enable_voice_linkage, enable_influencer_capture, enable_incentives, enable_referrals, created_at, updated_at) VALUES ('d2b3c4d5-6e7f-8a9b-0c1d-2e3f4a5b6c7d', 't_itl_001', 'b_sakura', 'loc_downtown', 'Sakura Sushi Bar — Downtown', 'https://g.page/r/sakura-sushi/review', ${rushHours2}, 48, true, false, false, true, '2026-01-20T08:00:00Z', '2026-02-12T09:00:00Z')`;

  await sql`INSERT INTO campaigns (campaign_id, tenant_id, business_id, location_id, name, google_review_url, rush_hours, thank_window_hours, enable_voice_linkage, enable_influencer_capture, enable_incentives, enable_referrals, created_at, updated_at) VALUES ('e3c4d5e6-7f8a-9b0c-1d2e-3f4a5b6c7d8e', 't_itl_001', 'b_burgertown', 'loc_mall', 'BurgerTown Express — Mall Location', 'https://g.page/r/burgertown/review', ${rushHours3}, 24, true, false, true, false, '2026-02-01T12:00:00Z', '2026-02-14T16:00:00Z')`;
